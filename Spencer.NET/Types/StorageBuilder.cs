...
namespace Spencer.NET
{
    public class StorageBuilder : Builder<Storage, StorageBuilder, IStorage>
    {
        ...
        {
            ServicesGenerator = new ServicesGenerator(new TypeIsClassValidator(), new ImplementationsFinder(), ServiceGeneratorFactory.MakeInstance());

            ServiceRegistrar = new ServiceRegistrar(new RegistratedServicesFilter());
