            ...
            return new Container(
                new ServiceResolver(
                    ...
                    new MemberValuesInjector(new MemberValueSetter(),
                        typedMemberValueProvider, new InjectFlagsProvider(),new MemberDeclarationTypeProvider()),new InstanceMembersValueInjector(new MemberValueSetter(), new InstanceMembersFinder())),
